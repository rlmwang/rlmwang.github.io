...
Module['FS_createPath']("/assets", "packs", true, true);
Module['FS_createPath']("/assets", "tiles", true, true);
Module['FS_createPath']("/assets", "waves", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/fonts/monogram-bitmap.png", "start": 0, "end": 1376}, {"filename": "/assets/fonts/monogram.ttf", "start": 1376, "end": 11844}, {"filename": "/assets/packs/farm.csv", "start": 11844, "end": 12368}, {"filename": "/assets/tiles/base-set.aseprite", "start": 12368, "end": 18645}, {"filename": "/assets/tiles/base-set.png", "start": 18645, "end": 26936}, {"filename": "/assets/tiles/dominos.aseprite", "start": 26936, "end": 45558}, {"filename": "/assets/tiles/dominos.png", "start": 45558, "end": 57575}, {"filename": "/assets/tiles/interface.aseprite", "start": 57575, "end": 63267}, {"filename": "/assets/tiles/interface.png", "start": 63267, "end": 68196}, {"filename": "/assets/tiles/monsters.aseprite", "start": 68196, "end": 71409}, {"filename": "/assets/tiles/monsters.png", "start": 71409, "end": 75122}, {"filename": "/assets/waves/level_0.csv", "start": 75122, "end": 75808}, {"filename": "/assets/waves/level_1.csv", "start": 75808, "end": 76884}, {"filename": "/assets/waves/level_2.csv", "start": 76884, "end": 77980}], "remote_package_size": 77980});

  })();

// end include: /tmp/tmpq6egbqyi.js
// include: /tmp/tmpw7c5mutg.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpw7c5mutg.js
// include: /tmp/tmpcrc7xvkr.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpcrc7xvkr.js
...
var ASM_CONSTS = {
  165768: () => { if (document.fullscreenElement) return 1; },  
 165814: () => { return document.getElementById('canvas').width; },  
 165866: () => { return parseInt(document.getElementById('canvas').style.width); },  
 165934: () => { document.exitFullscreen(); },  
 165961: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 166034: () => { if (document.fullscreenElement) return 1; },  
 166080: () => { return document.getElementById('canvas').width; },  
 166132: () => { return screen.width; },  
 166157: () => { document.exitFullscreen(); },  
 166184: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 166317: () => { return window.innerWidth; },  
 166343: () => { return window.innerHeight; },  
 166370: () => { if (document.fullscreenElement) return 1; },  
 166416: () => { return document.getElementById('canvas').width; },  
 166468: () => { return parseInt(document.getElementById('canvas').style.width); },  
 166536: () => { if (document.fullscreenElement) return 1; },  
 166582: () => { return document.getElementById('canvas').width; },  
 166634: () => { return screen.width; },  
 166659: () => { return window.innerWidth; },  
 166685: () => { return window.innerHeight; },  
 166712: () => { if (document.fullscreenElement) return 1; },  
 166758: () => { return document.getElementById('canvas').width; },  
 166810: () => { return screen.width; },  
 166835: () => { document.exitFullscreen(); },  
 166862: () => { if (document.fullscreenElement) return 1; },  
 166908: () => { return document.getElementById('canvas').width; },  
 166960: () => { return parseInt(document.getElementById('canvas').style.width); },  
 167028: () => { document.exitFullscreen(); },  
 167055: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 167113: () => { return screen.width; },  
 167138: () => { return screen.height; },  
 167164: () => { return window.screenX; },  
 167191: () => { return window.screenY; },  
 167218: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 167271: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 167342: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 167399: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 167655: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 167726: () => { if (document.fullscreenElement) return 1; },  
 167772: () => { return window.innerWidth; },  
 167798: () => { return window.innerHeight; },  
 167825: () => { if (document.pointerLockElement) return 1; }
};
